...
def get_dataset(args):
    ...
    if args.dataset == 'cifar':
        ...
        if args.dataset == 'mnist':
            data_dir = '~/fl_data/mnist'
        else:
            data_dir = '~/fl_data/fmnist/'
        ...
        if is_download:
            ...
            dataset_train = datasets.SVHN(data_dir, split='train', download=True, transform=trans_svhn)
            dataset_extra = datasets.SVHN(data_dir, split='extra', download=True, transform=trans_svhn)    
            train_dataset = torch.utils.data.ConcatDataset([dataset_train, dataset_extra])                                      
        ...
        if not is_download:
            ...
            #                             transform=trans_svhn)
            dataset_train = datasets.SVHN(data_dir, split='train', download=False, transform=trans_svhn)
            dataset_extra = datasets.SVHN(data_dir, split='extra', download=False, transform=trans_svhn)    
            train_dataset = torch.utils.data.ConcatDataset([dataset_train, dataset_extra])                                          
